	...
	requestPasswordReset: function(req, res,next){
	  ...
	  function(user){
		  ...
		  if (user == null){
			...
			mail.sendMessage(email,"Hai richiesto il reset della tua password. <a href='http://185.58.194.123:8080/#/resetPwd/"  + email + "/" + user._id + "'>fai click qui per procedere!</a>")
